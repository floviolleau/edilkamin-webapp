...
import {useErrorContext, ErrorType} from '../../../../context/error';
...
export default async function Page({params: {locale}}: Readonly<{
    params: {
        locale: string
    };
}>) {
        ...
        <Container>
            ...
            >
                <Tab eventKey="environment-infos" title={t('enviroment_infos')}>
                    <EnvironmentInfos locale={locale} />
                </Tab>
                <Tab eventKey="software-infos" title={t('software_infos')}>
                    <SoftwareInfos locale={locale} />
                </Tab>
            </Tabs>
        </Container>
    );
